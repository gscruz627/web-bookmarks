...
namespace WebBookmarks.Controllers
{
    ...
    public class UsersController : ControllerBase
    {
        ...
        public string GetAccessToken(User user)
        {
            ...
            SymmetricSecurityKey key = new SymmetricSecurityKey(Encoding.UTF8.GetBytes("VeryVeryVeryLongKeyVeryVeryVeryLongKey123123VeryVeryVeryLongKeyVeryVeryVeryLongKey123123"));
